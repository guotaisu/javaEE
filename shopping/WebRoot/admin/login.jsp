				...
				<TABLE cellSpacing=0 cellPadding=0 width=468 bgColor=#ffffff
					...
					<tr>
						<TD width=16><IMG height=122 src="images/admin/login_3.jpg"
							width=16></TD>
						<td align="center">
							<form onsubmit="return false;" action="chklogin.action"
								...
								<table width=366 border=0 align="center" cellPadding=0
									...
									<tr>
										...
										<TD colspan="2" align="left"
											style="padding-left: 0px; ! important padding-left: 4px;">
											<input type="submit" class="button" value="登录" id="enter" />
											<a href="admin/register.jsp"><input type="button"
												class="button" value="注册" id="register" /> </a>
										</TD>
									</tr>
