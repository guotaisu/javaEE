...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="all">
			<img src="images/admin/menu_plus.gif" id="allmenu" />
		</div>
		<div class="main">
			<div class="menus">
				<ul id="menu">
					<li class="title">
						<a href="javascript:void(0);"><b>网站设置</b> </a>
 <!--						<ul class="menuhide">
							<li>
								<img src="../images/admin/menu_arrow.gif" />
								&nbsp;
								<a href="javascript:void(0)" target="mainFrame">系统设置</a>
							</li>
							<li>
								<img src="../images/admin/menu_arrow.gif" />
								&nbsp;
								<a href="__URL__/user" target="mainFrame">管理员设置</a>
							</li>
						</ul>
					</li>
					<li class="title">
						<a href="javascript:void(0)"><b>首页设置</b> </a>
						<ul class="menuhide">
							<li>
								<img src="/images/admin/menu_arrow.gif" />
								&nbsp;
								<a href="#" target="mainFrame">滚动图片</a>
							</li>
							<li>
								<img src="/images/admin/menu_arrow.gif" />
								&nbsp;
								<a href="__URL__/flink" target="mainFrame">友情链接</a>
							</li>
							<li>
								<img src="/images/admin/menu_arrow.gif" />
								&nbsp;
								<a href="__URL__/hzqy" target="mainFrame">合作企业</a>
							</li>
						</ul>
					</li>

					<li class="title">
						<a href="javascript:;" target="mainFrame"><b>商品管理</b> </a>
						<ul class="menuhide">
							<li>
								<img src="images/admin/menu_arrow.gif" />
								&nbsp;
								<a href="goods.action" target="mainFrame">商品列表</a>
							</li>
							<li>
								<img src="images/admin/menu_arrow.gif" />
								&nbsp;
								<a href="addgoods.action" target="mainFrame">添加商品</a>
							</li>
							<li>
								<img src="images/admin/menu_arrow.gif" />
								&nbsp;
								<a href="typelist.action" target="mainFrame">商品分类列表</a>
							</li>
							<li>
								<img src="images/admin/menu_arrow.gif" />
								&nbsp;
								<a href="addgoodstype.action" target="mainFrame">添加商品分类</a>
							</li>
						</ul>
					</li>
 -->
					<li class="title">
						<a href="javascript:;" target="mainFrame"><b>订单管理</b> </a>
						<ul class="menuhide">
							<li>
								<img src="images/admin/menu_arrow.gif" />
								&nbsp;
								<a href="showorder.action" target="mainFrame">订单列表</a>
							</li>
<!-- 							<li>
								<img src="images/admin/menu_arrow.gif" />
								&nbsp;
 					...
 					<li class="title">
						<a href="javascript:void(0);"><b>用户管理</b> </a>
						<ul class="menuhide">
							<li>
								<img src="../images/admin/menu_arrow.gif" />
								&nbsp;
								<a href="userlist.action" target="mainFrame">用户信息</a>
							</li>
